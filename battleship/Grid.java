...
public class Grid
{
    ...
    public boolean validPlacement(int row, int col, int direction, int length)
    {
        ...
        {
            if(direction == VERTICAL && col + length > NUM_COLS)
            {
                return false;
            }
            else if(direction == VERTICAL && grid[row][col+i].hasShip())
            {
                return false;
            }
            else if(direction == HORIZONTAL && row + length > NUM_ROWS)
            {
                return false;
            }
            else if(direction == HORIZONTAL && grid[row+i][col].hasShip())
            {
                return false;
            }
        }
